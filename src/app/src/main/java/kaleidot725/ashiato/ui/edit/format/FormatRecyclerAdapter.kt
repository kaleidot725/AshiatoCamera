...
class FormatRecyclerAdapter(owner : LifecycleOwner, vms: List<FormatRecyclerViewModel>) : RecyclerView.Adapter<FormatRecyclerHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FormatRecyclerHolder {
        ...
        val binding = DataBindingUtil.inflate<FormatRecyclerItemBinding>(inflater, R.layout.format_recycler_item, parent, false)
